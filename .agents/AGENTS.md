...
- **Continuity Engine:** Run `sr6 continuity .` to index character relationships, contacts, locations, and narrative heatmaps into `reference/story_continuity.md`.
- **Dossier & Ledger Auditor:** Run `sr6 characters audit velvet` or `sr6 sync-all` to verify Karma/Nuyen balance consistency, Initiation grade calculations, and reputation balances against SRM rules.
