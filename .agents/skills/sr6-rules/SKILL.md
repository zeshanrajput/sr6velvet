---
name: sr6-rules
description: Query official Shadowrun 6th Edition (SR6) rules, character creation costs, spell mechanics, summoning, metamagic, and Missions authority levels using the Gemini RAG rules vault service.
---

# Shadowrun 6e Rules & RAG Reference Skill

Use this skill whenever you need to check official Shadowrun 6th Edition (SR6) rules, calculate Karma or Nuyen advancement costs, verify spellcasting or conjuring mechanics, look up spell/gear stats, or resolve rules priority according to official Shadowrun Missions (SRM) guidelines.
...
2. **[LEVEL 2] Supplemental Sourcebooks**: (`Street Lethal`, `Companion`, `Double Clutch`, `Street Grimoire`, etc.) - Modifies and expands base rules.
